...
<html>
	<head>
		...
		<!-- Animate CSS -->
		<link href="estilo/css/animate.min.css" rel="stylesheet">
		<!-- Basic stylesheet -->
		<link rel="stylesheet" href="estilo/css/owl.carousel.css">
		<!-- Font awesome CSS -->
		<link href="estilo/css/font-awesome.min.css" rel="stylesheet">		
		<!-- Custom CSS -->
		<link href="estilo/css/style.css" rel="stylesheet">
		<link href="estilo/css/style-color.css" rel="stylesheet">
		
		<!-- Favicon -->
		<link rel="shortcut icon" href="estilo/img/logo/favicon.ico">
	</head>
	
	<body>
		<section style="background:#393d42">
		...
		<!-- WayPoints JS -->
		<script src="estilo/js/waypoints.min.js"></script>
		<!-- Include js plugin -->
		<script src="estilo/js/owl.carousel.min.js"></script>
		<!-- One Page Nav -->
		<script src="estilo/js/jquery.nav.js"></script>
		<!-- Respond JS for IE8 -->
		<script src="estilo/js/respond.min.js"></script>
		<!-- HTML5 Support for IE -->
		<script src="estilo/js/html5shiv.js"></script>
		<!-- Custom JS -->
		<script src="estilo/js/custom.js"></script>
	</body>	
</html>